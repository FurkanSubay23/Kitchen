...
function filterItems(category) {
    if (category === "All") {
        ...
        let ItemsCategory = menu.filter((item) => {
...
function displayItems(itemsList) {
    let itemsDisplay = itemsList.map((item) => {
        return `
